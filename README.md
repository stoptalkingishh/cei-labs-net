...
| **Core Switch** | 24-Port Managed Layer 2 Gigabit Switch | Must support **802.1Q VLAN tagging** and Access Control Lists (ACLs); **RA-Guard** recommended if available (blocks rogue IPv6 router advertisements on player ports — see `docs/network-topology.md` §1). (e.g., TP-Link JetStream series). |
